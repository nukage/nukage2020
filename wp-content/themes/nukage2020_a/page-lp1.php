            ...
            <div class="  px-5  pb-32">
                <div class="container mx-auto flex flex-row   bg-white px-10  max-w-5xl">
                    <div class="w-2/3  pt-8 ">
                        <h1 class="text-4xl uppercase     leading-tight text-center font-black"> <span class="text-3xl"><?php _e( 'If you\'re looking to embark on a journey, turn up the bass and JOIN ME...', 'nukage2020_a' ); ?></span><br> <?php _e( '"Hyper-modern, uplifting dance music interwoven with aggressive bass lines, pop hooks, infectious vocals and otherworldly sound design"', 'nukage2020_a' ); ?> </h1>
                        <h2 class="text-black text-center mt-3 mb-5 text-2xl"><?php _e( '...Now you can get a FREE DOWNLOAD of the music that’s taking over the Melodic Dubstep Scene!', 'nukage2020_a' ); ?></h2>
