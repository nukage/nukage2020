                    ...
                    <div class="md:w-2/3 w-full container flex flex-col quick-list-holder md:pl-16   items-center justify-center">
                        ...
                        <div class="uppercase text-gray-500 mb-4 fade-anim raleway font-extrabold mt-3 fade-anim trans">
                            <div class="rotator inline-block trans ">
                                ...
                                <div class="inline">
                                    <?php _e( 'Live Performer', 'nukage2020_a' ); ?>
                                </div>
                                <div class="inline">
                                    <?php _e( 'Live DJ', 'nukage2020_a' ); ?>
                                </div>
                                <div class="inline">
                                    <?php _e( 'Recording Artist', 'nukage2020_a' ); ?>
                                </div>
                                <div class="inline">
                                    <?php _e( 'Multi-Instrumentalist', 'nukage2020_a' ); ?>
                                </div>
                            </div>
                        </div>
                        <div class="w-2/3 m-auto font-hairline">
                            <div class=" flex lg:flex-row flex-col flex-wrap p-0 text-center leading-loose xl:text-base text-sm uppercase mt-6 ">
                                <div class="lg:w-1/2 w-full p-0 mb-3 slide-in-anim ">
                                    <span class="font-medium"><?php _e( 'GENRES:', 'nukage2020_a' ); ?></span>
                                    <br class="lg:inline hidden">
                                    <?php _e( 'Dubstep, Future Bass, Trap', 'nukage2020_a' ); ?>
                                </div>
                                <div class="lg:w-1/2 w-full p-0 mb-3 slide-in-anim">
                                    <span class="font-medium"><?php _e( 'DJ SUPPORT:', 'nukage2020_a' ); ?></span>
                                    <br class="lg:inline hidden">
                                    <?php _e( 'Ill Gates, KJ Sawka, Architekt', 'nukage2020_a' ); ?>
                                </div>
                                <div class="lg:w-1/2 w-full p-0 mb-3 slide-in-anim">
                                    <span class="font-medium"><?php _e( 'PERFOMANCE STYLE:', 'nukage2020_a' ); ?> </span>
                                    <br class="lg:inline hidden">
                                    <?php _e( 'Live PA or DJ Set', 'nukage2020_a' ); ?>
                                </div>
                                <div class="lg:w-1/2 w-full p-0 mb-3 slide-in-anim">
                                    <span class="font-medium"><?php _e( 'CHART TOPPING:', 'nukage2020_a' ); ?> </span>
                                    <br class="lg:inline hidden">
                                    <?php _e( '5 BEATPORT CHARTING RELEASES', 'nukage2020_a' ); ?>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="w-full">
        ...
        <div class="bio-bg  gray-txt-1 font-medium ">
            <div class="bio-overlay   pt-32 pb-32">
                <div class="container mx-auto">
                    <h3 class="section-title "><?php _e( 'Bio', 'nukage2020_a' ); ?></h3>
    ...
    <section id="press">
        <div class="press-bg">
            <div class="press-overlay pt-32 pb-24">
                <div class="container mx-auto">
                    <h3 class="section-title  "><?php _e( 'Press &amp; Features', 'nukage2020_a' ); ?></h3>
                    <div class="header-strips-1"></div>
    ...
    <section id="videos">
        <div class="videos-bg">
            <div class="videos-overlay  pt-32 pb-24">
                <div class="container mx-auto ">
                    <h3 class="section-title "><?php _e( 'Videos', 'nukage2020_a' ); ?></h3>
                    <div class="header-strips-1"></div>
    ...
    <section id="music">
        <div class="music-bg">
            <div class="music-overlay pt-32 pb-24">
                <div class="container mx-auto ">
                    <h3 class="section-title  "><?php _e( 'Music', 'nukage2020_a' ); ?></h3>
                    <div class="header-strips-1"></div>
    ...
    <section id="contact">
        <div class="contact-bg ">
            <div class="contact-overlay pt-16 pb-32">
                <h3 class="section-title   pt-24"><?php _e( 'Contact', 'nukage2020_a' ); ?></h3>
                <div class="header-strips-1"></div>
