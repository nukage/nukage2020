...
*/
?>
<?php get_header( 'single-mix-download' ); ?>
    ...
    <div class="links-content bg-white mx-auto  opacity-100 z-10 relative max-w-md ">
        ...
        <div class=" p-1">
            <div class="text-center uppercase ">
                <h1 class="text-3xl text-black"><?php _e( 'MINI MIX 001: TRAP DOORS EDITION', 'nukage2020' ); ?></h1>
                <h2 class="text-xl text-black"><?php _e( 'by Nukage', 'nukage2020' ); ?></h2>
            </div>
            <div class="the-links">
                <h3 class="rounded bg-black p-2 text-white mt-4"><?php _e( 'Free Download', 'nukage2020' ); ?></h3>
                <ul> 
                    <li class="flex flex-row justify-between my-2 py-3 border-solid border-b border-gray  ">
                        <div class=" ml-2  oswald text-3xl font-black">
                ...
                <h3 class="rounded bg-black p-2 text-white mt-4"><?php _e( 'Stream', 'nukage2020' ); ?></h3>
                <ul> 
                    <li class="flex flex-row justify-between my-2 py-3 border-solid border-b border-gray   ">
...
<?php get_footer( 'single-mix-download' ); ?>