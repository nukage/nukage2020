        ...
        <div class="bg-albumart bg-cover bg-black h-full">
            ...
            <div class="links-content bg-white mx-auto  opacity-100 z-10 relative max-w-md ">
                ...
                <div class=" p-1">
                    ...
                    <div class="the-links">
                        <ul>
                            <li class="flex flex-row justify-between my-3 py-2 border-solid border-b border-gray  ">
                                <div class=" ml-2  oswald text-3xl text-red-500 font-black">
                                    <?php _e( 'FREE DOWNLOAD', 'nukage2020' ); ?>
                                </div>
                                <div id="email-download-togg" class="h-8 px-2 py-1 bg-black rounded-lg text-white uppercase hover:bg-risered trans cursor-pointer  ">
                    ...
                    .download-box-shown{
                        ...
                        display:block;
                            ...
                            <div id="download-box" class="down">
